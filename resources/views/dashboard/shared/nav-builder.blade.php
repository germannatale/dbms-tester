...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/brand/cure_logo_text.png') }}" width="118" height="46" alt="Cure Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/brand/cure_logo.png') }}" width="46" height="46" alt="Cure Logo">
        </div>
